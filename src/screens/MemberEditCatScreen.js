    ...
    return (
      ...
      >
                  ...
                  <View style={Styles.items}>
                    {
                      <View style={Styles.empty}>
                        ...
                        <Text style={Styles.emptyText}>
                          Danh mục dịch vụ này chưa có dịch vụ nào, vui lòng
                          nhấn "Thêm dịch vụ" để thêm dịch vụ.
                        </Text>
                      </View>
                    }
                  </View>
        ...
        <WAAlert
          ...
          question={
            "Bạn có chắc chắn muốn xoá dịch vụ này ra khỏi danh sách dịch vụ của salon"
          }
          titleFirst={true}
          title={"Xoá dịch vụ"}
        />
